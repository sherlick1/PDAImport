...
namespace PDAImport
{
    ...
    public class STMPEmailClass
    {
        private readonly SmtpClient _smtpServer;
        private readonly MailAddress _fromAddress;

        public STMPEmailClass()
        {
        ...
        public STMPEmailClass(string smtpHost, int smtpPort, bool enableSsl, string userName, string password, string fromEmail, string fromName) : this()
        {
        ...
        public bool Send(string address, string mailSubject, string htmlMessageBody, string fileName = null)
        {
            return Send(new List<MailAddress> { new MailAddress(address) }, mailSubject, htmlMessageBody, fileName);
        }

        public bool Send(List<MailAddress> addressList, string mailSubject, string htmlMessageBody, string fileName = null)
        {
